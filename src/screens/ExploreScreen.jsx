...
const ExploreScreen = () => {
  ...
  }, [activeFilters, activeSearch, activeRating]); 
        ...
        <div className="recipe-grid">
          {recipes.length > 0 ? (
            ...
            <div className="empty-state">
              ...
              {(activeSearch || activeFilters.length > 0 || activeRating > 0) && (
                <button 
                  className="clear-filters-btn"
                  onClick={() => {
                    setSearchTerm(''); setActiveSearch(''); setActiveFilters([]); setActiveRating(0);
                  }}
                >
                  Clear All Filters
                </button>
